...
void handle_arguments(int argc, char *argv[], asp::MapprojOptions &opt)
{
  ...
  general_options.add_options()("nodata-value", po::value(&opt.nodata_value)->default_value(-32768),
                                "No-data value to use unless specified in the input image.")("t_srs", po::value(&opt.target_srs_string)->default_value(""),
                                                                                             "Specify the output projection as a GDAL projection string (WKT, GeoJSON, or PROJ). If not provided, use the one from the DEM.")("tr", po::value(&opt.tr)->default_value(NaN),
                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                              "image will extend for an additional half a pixel at each edge).")("mpp", po::value(&opt.mpp)->default_value(NaN),
                                                                                                                                                                                                                                                                                                 "Set the output file resolution in meters per pixel.")("ppd", po::value(&opt.ppd)->default_value(NaN),
                                                                                                                                                                                                                                                                                                                                                        "Set the output file resolution in pixels per degree.")("datum-offset", po::value(&opt.datum_offset)->default_value(0),
                                                                                                                                                                                                                                                                                                                                                                                                                "When projecting to a datum instead of a DEM, use this elevation in meters from the datum.")("query-projection", po::bool_switch(&opt.isQuery)->default_value(false),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             "Display the computed projection information and estimated ground sample distance (pixel size on the ground), and quit. Used by the mapproject script.")("session-type,t", po::value(&opt.stereo_session),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Select the stereo session type to use for processing. Usually the program can select this automatically by the file extension, except for xml cameras. See the doc for options.")("t_projwin", po::value(&opt.target_projwin),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         "Limit the map-projected image to this region, with the corners given in georeferenced coordinates (xmin ymin xmax ymax). Max is exclusive.")("t_pixelwin", po::value(&opt.target_pixelwin),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "Limit the map-projected image to this region, with the corners given in pixels (xmin ymin xmax ymax). Max is exclusive.")("bundle-adjust-prefix", po::value(&opt.bundle_adjust_prefix),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "Use the camera adjustment obtained by previously running bundle_adjust with this output prefix.")("ot", po::value(&opt.output_type)->default_value("Float32"), "Output data type, when the input is single channel. Supported types: Byte, UInt16, Int16, UInt32, Int32, Float32. If the output type is a kind of integer, values are rounded and then clamped to the limits of that type. This option will be ignored for multi-channel images, when the output type is set to be the same as the input type.")("nearest-neighbor", po::bool_switch(&opt.nearest_neighbor)->default_value(false),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "Use nearest neighbor interpolation.  Useful for classification images.")("mo", po::value(&opt.metadata)->default_value(""), "Write metadata to the output file. Provide as a string in quotes if more than one item, separated by a space, such as 'VAR1=VALUE1 VAR2=VALUE2'. Neither the variable names nor the values should contain spaces.")("no-geoheader-info", po::bool_switch(&opt.noGeoHeaderInfo)->default_value(false),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Do not write metadata information in the geoheader. See the doc for more info.")("query-pixel", po::value(&opt.query_pixel)->default_value(vw::Vector2(NaN, NaN)),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        "as DEM column, row, height. Quit afterwards.")("aster-use-csm",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        po::bool_switch(&opt.aster_use_csm)->default_value(false)->implicit_value(true),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        "Use the CSM model with ASTER cameras (-t aster).")("parse-options", po::bool_switch(&opt.parseOptions)->default_value(false),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            "Parse the options and print the results. Used by the mapproject script.")("query-pixels", po::value(&opt.query_pixels)->multitoken()->default_value(std::vector<vw::Vector2>(), "[]"),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "as DEM column, row, height. Quit afterwards.")("query-pixels-output", po::value(&opt.query_pixels_output)->default_value("query_pixels_output.csv"),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "Output CSV file for storing the query pixels results.");
  general_options.add(vw::GdalWriteOptionsDescription(opt));

  po::options_description positional("");
  positional.add_options()("dem", po::value(&opt.dem_file))("camera-image", po::value(&opt.image_file))("camera-model", po::value(&opt.camera_file))("output-image", po::value(&opt.output_file));
  ...
  if (opt.parseOptions)
  {
    ...
    {
      vw_out() << "query_pixel," << opt.query_pixel << std::endl;
    }
                       ...
                       GeoReference const &dem_georef)
{
  ...
  Vector3 xyz = dem_georef.datum().geodetic_to_cartesian(Vector3(lonlat[0], lonlat[1], height.child()));
    ...
    BBox2 &cam_box, GeoReference &target_georef)
{
  ...
  else
  {
    ...
    { // Not projected, GDC coordinates only.
...
// Write query pixels results to a CSV file
void write_query_pixels_to_csv(const std::string &filename,
                               const std::vector<vw::Vector2> &query_pixels,
                               const std::vector<vw::Vector3> &results)
{
  // Open output CSV file
  std::ofstream file(filename);
  if (!file)
  {
    vw::vw_throw(vw::IOErr() << "Unable to open file for writing: " << filename);
  }

  // Write CSV header
  file << "# Results from mapproject query_pixels\n"
       << "# Column descriptions:\n"
       << "# input_pixel_x,input_pixel_y: Image coordinates of input pixels\n"
       << "# lon,lat,height: Intersection point with DEM in geodetic coordinates\n"
       << "input_pixel_x,input_pixel_y,lon,lat,height\n";
  ...
  file.close();
  vw::vw_out() << "Wrote query results to: " << filename << "\n";
}
...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    asp::SessionPtr session(asp::StereoSessionFactory::create(opt.stereo_session, // in-out
                                                              opt,
    ...
    if (!std::isnan(opt.query_pixel[0]) && !std::isnan(opt.query_pixel[1]))
    {
      vw::Vector3 result = asp::queryPixel(opt.dem_file, opt.camera_model, opt.query_pixel);
      return 0;
    }
    ...
    if (!opt.query_pixels.empty())
    {
      std::vector<vw::Vector3> results = asp::queryPixels(opt.dem_file, opt.camera_model, opt.query_pixels);
      write_query_pixels_to_csv(opt.query_pixels_output, opt.query_pixels, results);
      return 0;
    }
    ...
    if (!std::isnan(opt.mpp))
    { // Meters per pixel was set
      if (std::isnan(opt.ppd))
        opt.ppd = 2.0 * M_PI * radius / (360.0 * opt.mpp);
    }
    if (!std::isnan(opt.ppd))
    { // Pixels per degree was set
      if (std::isnan(opt.mpp))
    ...
    if (opt.isQuery)
    { // Quit before we do any image work
